...
def get_all_tweets(screen_name):
        ...
        try:#make initial request for most recent tweets (200 is the maximum allowed count)
...
def twitter():
    if request.method == 'POST' :
        if 'twitter' in request.form:
            ...
            print (handle)
            return redirect(url_for('get_all_tweets', screen_name = handle))
    print ('1')
    return render_template("twitter.html")
