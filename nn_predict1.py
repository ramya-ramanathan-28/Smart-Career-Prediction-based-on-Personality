...
vocab_to_intorg = data['vocab_to_int']
...
text=read_data("input/tweet_liam.txt")
...
vocab2 = sorted(word_count, key=word_count.get, reverse=True)
print (vocab2)
vocab = vocab + vocab2
# Create your dictionary that maps vocab words to integers here
vocab_to_int = {word: ii for ii, word in enumerate(vocab, 1)}
#vocab_to_int=vocab_to_int+vocab_to_int2
...
#vocab_to_int = merge_two_dicts(vocab_to_intorg, vocab_to_int2)
seq_len = 500
...
n_words = len(vocab_to_intorg) + 1 # Adding 1 because we use 0's for padding, dictionary started at 1
print ('1')
